...
if __name__ == '__main__':
    ...
    train_X = np.array(
        [[cyk_dist.v('D_{}'.format(i)) for i in range(0, 10)], [cyk_dist.v('E_{}'.format(i)) for i in range(0, 10)],
         [cyk_dist.v('F_{}'.format(i)) for i in range(0, 10)], [cyk_dist.v('G_{}'.format(i)) for i in range(0, 10)]])
